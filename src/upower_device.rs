// This code was autogenerated with `dbus-codegen-rust -s -g -m None -d org.freedesktop.UPower -p /org/freedesktop/UPower/devices/battery_BAT0`, see https://github.com/diwic/dbus-rs
use dbus as dbus;
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgFreedesktopDBusProperties for blocking::Proxy<'a, C> {
    ...
    fn get<R0: for<'b> arg::Get<'b> + 'static>(&self, interface_name: &str, property_name: &str) -> Result<R0, dbus::Error> {
        self.method_call("org.freedesktop.DBus.Properties", "Get", (interface_name, property_name, )).map(|r: (arg::Variant<R0>, )| (r.0).0)
    }
